...
<div  class="card mb-3 " style="width: 20.5rem;top: 2px;display: inline-grid; white-space: nowrap;">
    ...
    <div class="w3-card-3"> 
        ...
        <img style="height: 270px; width: 300px;" src="{{asset('storage/' . $padrao->image)}}">
    ...
    <div class="container">
        <h5 class="card-title" style="height:35px">
            ...
            <span class="card-title grey-text text-darken-4 truncate" title="{{$padrao->nome}}">{{$padrao->nome}}</span>
            <p style="margin-top: 10px;">R$ {{$padrao->id}} <a style="margin-left:10px;" class="btn  btn-outline-info" href="{{route('produto.show' ,$padrao->id)}}">Veja mais informações</a> </p>
    </div>
    ...
    <div class="card-body" style="margin-top: 20px;" >
        ...
        <div class="container" style="">
            ...
            <form method="post"action="{{route('favorito.store')}}">
                ...
                <a style="margin-left:50px; "href="{{route('adicionar',  $padrao->id)}}" class="btn btn-outline-info">  
